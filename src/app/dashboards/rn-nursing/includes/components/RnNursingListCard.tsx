  ...
  return (
    <div className="rounded-2xl border border-gray-200 bg-white shadow-sm flex flex-col h-full overflow-hidden">
      <style>{`
        ...
        .rn-nursing-list-scroll::-webkit-scrollbar-thumb { background-color: #14b8a6; border-radius: 9999px; }
        .rn-nursing-list-scroll::-webkit-scrollbar-thumb:hover { background-color: #0d9488; }
      `}</style>
