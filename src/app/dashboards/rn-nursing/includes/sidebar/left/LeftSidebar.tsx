...
export default function LeftSidebar() {
  ...
  const [activeDropdown, setActiveDropdown] = useState<string | null>(() => {
    if (typeof window !== "undefined") {
      const saved = localStorage.getItem("leftSidebarActiveDropdown_rn");
      return saved || "RN Nursing Exams";
    }
    return "RN Nursing Exams";
  });
  ...
  const toggleDropdown = (key: string) => {
    ...
    if (!isOpened) {
      ...
      setTimeout(() => {
        ...
        if (typeof window !== "undefined") localStorage.setItem("leftSidebarActiveDropdown_rn", newActive || "");
      }, 250);
    } else {
      newActive = activeDropdown === key ? null : key;
      setActiveDropdown(newActive);
    ...
    <>
      ...
      <nav className={`flex-1 overflow-y-auto space-y-1 p-2 left-sidebar-scroll ${isMobile ? "text-xs" : ""}`}>
        ...
        <AccordionGroup
          ...
          isActive={activeDropdown === "RN Nursing Exams"}
          onToggle={toggleDropdown}
          {...sharedNavProps}
        >
          <NavItem href={`${VISTA}/assessment/exams/absolute/overview`} label="HESI EXAM (RN)" {...sharedNavProps} />
          <NavItem href={`${VISTA}/assessment/exams/absolute/overview`} label="ATI Exam (RN)" {...sharedNavProps} />
          <NavItem href={`${VISTA}/assessment/exams/absolute/overview`} label="EXIT ATI Exam-RN" {...sharedNavProps} />
          <NavItem href={`${VISTA}/assessment/exams/absolute/overview`} label="EXIT HESI Exam-RN" {...sharedNavProps} />
          <NavItem href={`${VISTA}/assessment/exams/absolute/overview`} label="EXAMPLIFY Practice" {...sharedNavProps} />
          <NavItem href={`${VISTA}/assessment/exams/absolute/overview`} label="GENERAL Exams" {...sharedNavProps} />
        </AccordionGroup>
        ...
        <AccordionGroup
          ...
          icon={ClipboardCheck}
          label="RN Exit Exams"
          isActive={activeDropdown === "RN Exit Exams"}
          onToggle={toggleDropdown}
          {...sharedNavProps}
        >
          <NavItem href={`${VISTA}/assessment/exams/absolute/overview`} label="EXIT ATI Exam-RN" {...sharedNavProps} />
        ...
        >
          ...
          <NavItem href="/dashboards/rn-nursing" label="LPN Nursing Exam" {...sharedNavProps} />
