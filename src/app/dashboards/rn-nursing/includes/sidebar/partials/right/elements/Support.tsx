...
export default function NeedSupport({
  ...
  return (
    <Link href="/dashboards/ati-teas/vista/pages/support">
      <div
        onClick={handleItemClick}
        onMouseEnter={(e) => handleItemHover("Need Help", e)}
    ...
    ${!isOpened && "justify-center"}`}
      >
        ...
        {isOpened && <span className="ml-3">Need Help / Assistance</span>}

        {!isOpened && hoveredItem === "Need Help" && (
          <Tooltip
            x={tooltipPosition.x}
            y={tooltipPosition.y}
            position="left"
