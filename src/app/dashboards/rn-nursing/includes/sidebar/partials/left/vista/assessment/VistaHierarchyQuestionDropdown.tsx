...
const BASE_ROUTE = `/dashboards/${TARGET_PANEL}/vista/strata/${TARGET_GROUP}/questions/absolute`;
...
export default function VistaHierarchyQuestionDropdown({
  isOpened,
  activeDropdown,
  toggleDropdown,
  hoveredItem,
  ...
  const dropdownKey = "QuestionVistaHierarchy";
  ...
  return (
    <div className="relative">
      ...
      <div
        ...
        onMouseEnter={(e) => handleItemHover("QuestionVistaHierarchy", e)}
      ...
      >
        <div className="flex items-center">
          ...
          {isOpened && <span className="ml-3">Question Hierarchy</span>}
        </div>
      ...
      {!isOpened && hoveredItem === "QuestionVistaHierarchy" && (
        <Tooltip
          x={tooltipPosition.x}
          y={tooltipPosition.y}
        >
