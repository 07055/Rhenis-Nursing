  ...
  return (
    <div className="relative">
      ...
      <div
        ...
        onMouseEnter={(e) => handleItemHover("Content", e)}
      ...
      >
        <div className="flex items-center">
          ...
          {isOpened && <span className="ml-3">Access My Notes</span>}
        </div>
      ...
      {isOpened && isActive && (
        <div className="ml-8 mt-1 space-y-1">
          <Link href="/dashboards/admin/nexus/content">
            <div
          ...
          <Link href="/dashboards/admin/nexus/content/create">
            <div
              onClick={handleItemClick}
              className={`p-2 text-sm rounded-lg transition flex items-center gap-2 select-none
                  border-1 border-transparent hover:border-solid hover:border-[var(--text-color)]
