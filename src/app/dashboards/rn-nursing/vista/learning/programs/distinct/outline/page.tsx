...
import { useDistinctStrataPrograms } from "@/lib/hooks/nexus/strata/learning/programs/distinct/useDistinctStrataPrograms";
import type { StrataItem } from "@/lib/hooks/nexus/strata/learning/programs/distinct/useDistinctStrataPrograms";
        ...
        <div className="w-full overflow-x-auto rounded-xl border bg-[var(--content-bg)] text-[var(--text-color)]">
          <table className="w-full border-collapse text-sm">
            ...
            <tbody>
              ...
              {filteredPrograms.map((strataName, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-4 py-2 text-center">{strataName.coursesCount ?? 0}</td>
