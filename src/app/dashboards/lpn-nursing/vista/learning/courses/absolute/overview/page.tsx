...
import { useAbsoluteStrataCourses } from "@/lib/hooks/nexus/strata/learning/courses/absolute/useAbsoluteStrataCourses";
import type { StrataItem } from "@/lib/hooks/nexus/strata/learning/courses/absolute/useAbsoluteStrataCourses";
...
// const VISTA_STRATA_GROUP = "course";
                    ...
                    <div className="grid grid-cols-2 gap-x-1">
                      ...
                      <div className="space-y-0.5 pr-1 border-r border-[var(--text-color)]/20">
                        ...
                        <div className="flex justify-between gap-1">
                          ...
                          <span className="font-medium">{strataName.subjectsCount ?? 0}</span>
                        </div>
                      </div>
                      ...
                      <div className="space-y-0.5 pl-1">
                        ...
                        <div className="flex justify-between gap-1">
                          ...
                          <span className="truncate font-medium">{strataName.programName ?? "—"}</span>
                        </div>
                      </div>
