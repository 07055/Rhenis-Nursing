...
export default function LeftSidebar() {
  ...
  const [activeDropdown, setActiveDropdown] = useState<string | null>(() => {
    if (typeof window !== "undefined") {
      const saved = localStorage.getItem("leftSidebarActiveDropdown_lpn");
      return saved || "LPN Nursing Exams";
    }
    return "LPN Nursing Exams";
  });
  ...
  const toggleDropdown = (key: string) => {
    ...
    if (!isOpened) {
      ...
      setTimeout(() => {
        ...
        if (typeof window !== "undefined") localStorage.setItem("leftSidebarActiveDropdown_lpn", newActive || "");
      }, 250);
    } else {
      newActive = activeDropdown === key ? null : key;
      setActiveDropdown(newActive);
  ...
  return (
    <>
      ...
      <nav className={`flex-1 overflow-y-auto space-y-1 p-2 left-sidebar-scroll ${isMobile ? "text-xs" : ""}`}>
        ...
        {/* ─── LPN Nursing Exams ─── */}
        <AccordionGroup
          id="LPN Nursing Exams"
          icon={ClipboardCheck}
          label="LPN Nursing Exams"
          isActive={activeDropdown === "LPN Nursing Exams"}
          onToggle={toggleDropdown}
          {...sharedNavProps}
        >
          <NavItem href={`${VISTA}/assessment/exams/absolute/overview`} label="HESI Exams (LPN)" {...sharedNavProps} />
          <NavItem href={`${VISTA}/assessment/exams/absolute/overview`} label="ATI Exams (LPN)" {...sharedNavProps} />
          <NavItem href={`${VISTA}/assessment/exams/absolute/overview`} label="EXIT ATI Exams-LPN" {...sharedNavProps} />
          <NavItem href={`${VISTA}/assessment/exams/absolute/overview`} label="EXIT HESI Exams-LPN" {...sharedNavProps} />
          <NavItem href={`${VISTA}/assessment/exams/absolute/overview`} label="EXAMPLIFY Practice (PN)" {...sharedNavProps} />
          <NavItem href={`${VISTA}/assessment/exams/absolute/overview`} label="KAPLAN EXAMS" {...sharedNavProps} />
        </AccordionGroup>
        ...
        <AccordionGroup
          id="LPN Exit Exams"
          icon={ClipboardCheck}
          label="LPN Exit Exams"
          isActive={activeDropdown === "LPN Exit Exams"}
          onToggle={toggleDropdown}
          {...sharedNavProps}
        >
          <NavItem href={`${VISTA}/assessment/exams/absolute/overview`} label="EXIT ATI Exams-LPN" {...sharedNavProps} />
        ...
        <AccordionGroup
          ...
          {...sharedNavProps}
        >
          <NavItem href="/dashboards/ati-teas" label="ATI TEAS" {...sharedNavProps} />
          <NavItem href="/dashboards/hesi-a2" label="HESI A2" {...sharedNavProps} />
          <NavItem href="/dashboards/rn-nursing" label="RN Nursing Exam" {...sharedNavProps} />
          <NavItem href="/dashboards/lpn-nursing" label="LPN Nursing Exam" {...sharedNavProps} />
          ...
          <NavItem href="/dashboards/rn-nursing" label="RN Exit Exams" {...sharedNavProps} />
          <NavItem href="/dashboards/lpn-nursing" label="LPN Exit Exams" {...sharedNavProps} />
        </AccordionGroup>
