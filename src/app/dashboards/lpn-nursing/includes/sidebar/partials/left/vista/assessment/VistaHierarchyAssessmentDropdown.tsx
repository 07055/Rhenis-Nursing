...
const TARGET_GROUP = "assessment";
const BASE_ROUTE = `/dashboards/${TARGET_PANEL}/vista/strata/${TARGET_GROUP}/assessments/absolute`;
...
export default function VistaHierarchyAssessmentDropdown({
  isOpened,
  activeDropdown,
  toggleDropdown,
  hoveredItem,
  ...
  const dropdownKey = "AssessmentVistaHierarchy";
  ...
  return (
    <div className="relative">
      ...
      <div
        ...
        onMouseEnter={(e) => handleItemHover("AssessmentVistaHierarchy", e)}
      ...
      >
        <div className="flex items-center">
          ...
          {isOpened && <span className="ml-3">Assessment Hierarchy</span>}
        </div>
      ...
      {!isOpened && hoveredItem === "AssessmentVistaHierarchy" && (
        <Tooltip
          x={tooltipPosition.x}
          y={tooltipPosition.y}
        >
          Assessments Hierarchy
        </Tooltip>
      )}
