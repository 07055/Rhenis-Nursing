...
import { useDistinctStrataExams } from "@/lib/hooks/nexus/strata/assessment/exams/distinct/useDistinctStrataExams";
import type { StrataItem } from "@/lib/hooks/nexus/strata/assessment/exams/distinct/useDistinctStrataExams";
        ...
        <div className="w-full overflow-x-auto rounded-xl border bg-[var(--content-bg)] text-[var(--text-color)]">
          <table className="w-full border-collapse text-sm">
            ...
            <tbody>
              ...
              {filteredExams.map((strataName, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-4 py-2 truncate max-w-[220px]">{funcTruncateHelper(strataName.title)}</td>
                    ...
                    <td className="px-4 py-2 text-center">{strataName.sectionsCount ?? 0}</td>
