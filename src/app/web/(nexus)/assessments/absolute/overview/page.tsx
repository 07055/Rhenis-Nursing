...
// ───────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
// Main Component
export default function StrataAssessmentsPage() {
        ...
        <div className="w-full">
          ...
          <div className="mb-4 rounded-2xl border bg-[var(--content-bg)] text-[var(--text-color)] backdrop-blur-xl shadow-sm px-4 py-3 flex items-center gap-3">
            ...
            <div className="flex items-center gap-1.5 flex-1 min-w-0">
              <button
                onClick={() => {
                  const el = document.getElementById("assessments-sort-scroll");
              ...
              <div id="assessments-sort-scroll" className="flex-1 overflow-x-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
                    ...
                    <div className="grid grid-cols-2 gap-x-1">
                      ...
                      <div className="space-y-0.5 pr-1 border-r border-[var(--text-color)]/20">
                        ...
                        <div className="flex justify-between gap-1">
                          ...
                          <span className="font-medium">{strataName.examsCount ?? 0}</span>
                        </div>
                      </div>
