...
const BASE_CHILD_ROUTE = `/dashboards/${VISTA_STRATA_PANEL}/vista/strata/${VISTA_STRATA_GROUP}/${VISTA_CHILD_STRATA}`;
// const BASE_TOGGLE_ROUTE = `/dashboards/${VISTA_STRATA_PANEL}/vista/strata/${VISTA_STRATA_GROUP}/${VISTA_STRATA}`;

// ───────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
// Main Component
export default function StrataProgramsPage() {
        ...
        <div className="w-full">
          ...
          <div className="mb-4 rounded-2xl border bg-[var(--content-bg)] text-[var(--text-color)] backdrop-blur-xl shadow-sm px-4 py-3 flex items-center gap-3">
            ...
            <div className="flex items-center gap-1.5 flex-1 min-w-0">
              <button
                onClick={() => {
                  const el = document.getElementById("programs-sort-scroll");
              ...
              <div id="programs-sort-scroll" className="flex-1 overflow-x-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
                  ...
                  <div className="text-[11px] mt-1">
                    <div className="grid grid-cols-2 gap-x-1">
                      ...
                      <div className="space-y-0.5 pr-1 border-r border-[var(--text-color)]/20">
                        ...
                        <div className="flex justify-between gap-1">
                          <span className="opacity-50">Courses</span>
                      ...
                      <div className="space-y-0.5 pl-1">
                        ...
                        <div className="flex justify-between gap-1">
                          ...
                          <span className="font-medium">{strataName.isFree ? "Yes" : "No"}</span>
                        </div>
                      </div>
