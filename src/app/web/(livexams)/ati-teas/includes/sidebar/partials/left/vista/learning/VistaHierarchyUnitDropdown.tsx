...
const BASE_ROUTE = `/dashboards/${TARGET_PANEL}/vista/strata/${TARGET_GROUP}/units/absolute`;
...
export default function VistaHierarchyUnitDropdown({
  isOpened,
  activeDropdown,
  toggleDropdown,
  hoveredItem,
  ...
  const dropdownKey = "UnitVistaHierarchy";
  ...
  return (
    <div className="relative">
      ...
      <div
        ...
        onMouseEnter={(e) => handleItemHover("UnitVistaHierarchy", e)}
      ...
      >
        <div className="flex items-center">
          ...
          {isOpened && <span className="ml-3">Unit Hierarchy</span>}
        </div>
      ...
      {!isOpened && hoveredItem === "UnitVistaHierarchy" && (
        <Tooltip
          x={tooltipPosition.x}
          y={tooltipPosition.y}
        >
