...
const BASE_ROUTE = `/dashboards/${TARGET_PANEL}/vista/strata/${TARGET_GROUP}/programs/absolute`;
...
export default function VistaHierarchyProgramDropdown({
  isOpened,
  activeDropdown,
  toggleDropdown,
  hoveredItem,
  ...
  const dropdownKey = "ProgramVistaHierarchy";
  ...
  return (
    <div className="relative">
      ...
      <div
        ...
        onMouseEnter={(e) => handleItemHover("ProgramVistaHierarchy", e)}
      ...
      >
        <div className="flex items-center">
          ...
          {isOpened && <span className="ml-3">Program Hierarchy</span>}
        </div>
      ...
      {!isOpened && hoveredItem === "ProgramVistaHierarchy" && (
        <Tooltip
          x={tooltipPosition.x}
          y={tooltipPosition.y}
        >
