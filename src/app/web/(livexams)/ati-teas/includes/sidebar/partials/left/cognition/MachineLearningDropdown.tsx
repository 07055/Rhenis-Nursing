...
export default function MachineLearningDropdown({
  isOpened,
  activeDropdown,
  toggleDropdown,
  hoveredItem,
  ...
  const dropdownKey = "MachineLearning";
  ...
  return (
    <div className="relative">
      ...
      <div
        ...
        onMouseEnter={(e) => handleItemHover("MachineLearning", e)}
      ...
      >
        <div className="flex items-center">
          ...
          {isOpened && <span className="ml-3">Machine Learning</span>}
        </div>
      ...
      {!isOpened && hoveredItem === "MachineLearning" && (
        <Tooltip
          x={tooltipPosition.x}
          y={tooltipPosition.y}
        >
      ...
      {isOpened && isActive && (
        <div className="ml-8 mt-1 space-y-1">
          <Link href="/dashboards/admin/nexus/cognition/output">
            <div
            ...
            >
              ...
              <span>Machine Learning Output</span>
            </div>
          </Link>

          <Link href="/dashboards/admin/nexus/cognition/render">
            <div
              onClick={handleItemClick}
              className={`p-2 text-sm rounded-lg transition flex items-center gap-2 select-none
                  border-1 border-transparent hover:border-solid hover:border-[var(--text-color)]
            ...
            >
              <span className="w-2 h-2 rounded-full bg-[var(--text-color)]" />
              <span>Machine Learning Render</span>
            </div>
          </Link>
        </div>
      )}
