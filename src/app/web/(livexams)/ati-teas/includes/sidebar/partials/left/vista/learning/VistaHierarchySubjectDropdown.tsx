...
const BASE_ROUTE = `/dashboards/${TARGET_PANEL}/vista/strata/${TARGET_GROUP}/subjects/absolute`;
...
export default function VistaHierarchySubjectDropdown({
  isOpened,
  activeDropdown,
  toggleDropdown,
  hoveredItem,
  ...
  const dropdownKey = "SubjectVistaHierarchy";
  ...
  return (
    <div className="relative">
      ...
      <div
        ...
        onMouseEnter={(e) => handleItemHover("SubjectVistaHierarchy", e)}
      ...
      >
        <div className="flex items-center">
          ...
          {isOpened && <span className="ml-3">Subject Hierarchy</span>}
        </div>
      ...
      {!isOpened && hoveredItem === "SubjectVistaHierarchy" && (
        <Tooltip
          x={tooltipPosition.x}
          y={tooltipPosition.y}
        >
