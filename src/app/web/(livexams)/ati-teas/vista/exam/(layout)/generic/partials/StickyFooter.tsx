...
export default function Footer() {
  ...
  const goPrev = () => window.dispatchEvent(new CustomEvent("exam:prev"));
  const goNext = () => window.dispatchEvent(new CustomEvent("exam:next", { detail: { total } }));
  ...
  return (
    <>
      <footer
        className="sticky bottom-0 z-40 w-full select-none border-t transition-colors duration-300"
        style={{
          ...
          <div className="flex items-center gap-1 min-w-0">
            <div className="relative group">
              <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 hidden group-hover:flex flex-col items-center z-50 pointer-events-none">
                <div className="bg-gray-800 text-white text-[10px] font-medium px-2 py-1 rounded whitespace-nowrap">Previous Question</div>
                <div className="w-0 h-0 border-l-4 border-r-4 border-t-4 border-l-transparent border-r-transparent border-t-gray-800" />
              </div>
              <button
                onClick={goPrev}
                disabled={isFirst}
                className="flex items-center gap-1 px-2 py-1 border border-gray-700 hover:bg-indigo-200 rounded font-medium transition whitespace-nowrap disabled:opacity-40 disabled:cursor-not-allowed"
              >
                <ArrowLeft size={12} className="md:w-4 md:h-4 lg:w-5 lg:h-5" />
                Previous
              </button>
            </div>
          ...
          <div className="flex-shrink-0">
            {isLast ? (
              <div className="relative group">
                ...
                <button onClick={handleSubmit} className="flex items-center gap-1 px-3 py-1 bg-emerald-600 hover:bg-emerald-700 text-white rounded font-semibold transition whitespace-nowrap">
              ...
              <div className="relative group">
                <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 hidden group-hover:flex flex-col items-center z-50 pointer-events-none">
                  <div className="bg-gray-800 text-white text-[10px] font-medium px-2 py-1 rounded whitespace-nowrap">Next Question</div>
                  <div className="w-0 h-0 border-l-4 border-r-4 border-t-4 border-l-transparent border-r-transparent border-t-gray-800" />
                </div>
                <button onClick={goNext} disabled={isLast} className="flex items-center gap-1 px-3 py-1 bg-blue-600 hover:bg-blue-700 text-white rounded font-semibold transition whitespace-nowrap disabled:opacity-40 disabled:cursor-not-allowed">
                  Next <ArrowRight size={12} className="md:w-4 md:h-4 lg:w-5 lg:h-5" />
                </button>
              </div>
            )}
          </div>
