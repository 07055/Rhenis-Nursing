// src\app\web\(nursing)\atiteas\vista\exam\(layout)\glacial\partials\LowerStickyNavBar.tsx
"use client";
...
export default function LowerStickyNavBar({
    ...
    return (
        <>
            ...
            {/* Ribbon */}
            <div
                id="glacial-lower-nav"
                style={{ backgroundColor: "var(--exam-lower-nav-bg)", color: "var(--exam-lower-nav-text)", fontSize: "var(--exam-lower-nav-font-base)" }}
                className="w-full sticky top-[var(--upper-nav-height,56px)] z-[200] border-b border-border-var(--exam-lower-nav-text) shadow-sm backdrop-blur-md transition-colors duration-300 px-2 sm:px-4 py-0.5"
            >
