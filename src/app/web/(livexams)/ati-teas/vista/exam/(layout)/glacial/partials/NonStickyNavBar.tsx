// src\app\web\(nursing)\atiteas\vista\exam\(layout)\glacial\partials\NonStickyNavBar.tsx
"use client";
...
export default function NonStickyNavBar() {
  ...
  return (
    <>
      {/* NAVBAR */}
      <div
        className="w-full z-[200] border-b px-2 md:px-4 py-1 flex items-center justify-between gap-1 md:gap-3 text-[10px] md:text-sm lg:text-base transition-colors duration-300"
        style={{
