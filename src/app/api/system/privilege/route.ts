// D:\Estupendo\FastAPI\skewblanc\frontend\src\app\api\management\developer\privileges\route.ts
import { NextRequest, NextResponse } from "next/server";
import { getBackendBaseUrl } from "@/lib/api/api/api";

export interface SystemUserPrivilegeManagementResponse<T = unknown> {
  message?: string;
  error?: string;
...
async function forwardToBackend(
  ...
  try {
    ...
    console.log(`🌿 [privilegeRoute] Forwarding ${method} to:`, url);
    ...
    const responseBody: SystemUserPrivilegeManagementResponse = await backendResponse.json().catch(() => ({
