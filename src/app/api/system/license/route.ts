// D:\Estupendo\FastAPI\skewblanc\frontend\src\app\api\management\developer\roles\route.ts
...
async function forwardToBackend(
  ...
  try {
    ...
    const responseBody: SystemUserRoleManagementResponse = await backendResponse.json().catch(() => ({
