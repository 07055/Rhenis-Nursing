// frontend\src\app\api\system\role\route.ts
import { NextRequest, NextResponse } from "next/server";
import { getBackendBaseUrl } from "@/lib/api/api/api";

export interface SystemUserRoleManagementResponse<T = unknown> {
  message?: string;
  error?: string;
...
// Base Route Logic 📌
const TARGET_NAME = "role";
const BASE_ROUTE = `/api/castoline/system/user/${TARGET_NAME}`;
...
async function forwardToBackend(
  ...
  try {
    ...
    console.log("🔐 Forwarded session headers:", {
      "x-casto-line": castoLine ?? "NONE",
      "x-casto-badge": castoBadge ?? "NONE",
    });
    ...
    const responseBody: SystemUserRoleManagementResponse =
