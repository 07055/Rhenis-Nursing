...
export const useDistinctStrataSubjects = ({
  ...
  useEffect(() => {
    const fetchSubjects = async () => {
      try {
        console.log("🚀 [useDistinctStrataSubjects] Fetching Subjects . . . 🪝");
        ...
        console.error(
          "❌ [useDistinctStrataSubjects] Failed to fetch Subjects:",
          err
        );
      }
    };
    ...
    fetchSubjects();
  }, [parentIdentifier, subjectSearch, page, perPage, sortColumn, sortDirection]);

  // Pass Subjects when search changes [ Frontend is just to display !]
  useEffect(() => {
