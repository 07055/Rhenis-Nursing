...
export const useAbsoluteStrataFacts = ({
  page = 1,
  perPage = 20,
  sortColumn = null,
  sortDirection = "asc",
  ...
  useEffect(() => {
    const fetchFacts = async () => {
      try {
        console.log("🚀 [useAbsoluteStrataFacts] Fetching Facts ... 🪝");
        ...
        console.error(
          "❌ [useAbsoluteStrataFacts] Failed to fetch Facts:",
          err
        );
      }
    };
    ...
    fetchFacts();
  }, [factSearch, page, perPage, sortColumn, sortDirection]);
