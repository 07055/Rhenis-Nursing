...
export const useDistinctStrataTopics = ({
  ...
  useEffect(() => {
    const fetchTopics = async () => {
      try {
        console.log("🚀 [useDistinctStrataTopics] Fetching Topics . . . 🪝");
        ...
        console.error(
          "❌ [useDistinctStrataTopics] Failed to fetch Topics:",
          err
        );
      }
    };
    ...
    fetchTopics();
  }, [parentIdentifier, topicSearch, page, perPage, sortColumn, sortDirection]);

  // Pass Topics when search changes [ Frontend is just to display !]
  useEffect(() => {
