...
export const useDistinctStrataPrograms = ({
  ...
  useEffect(() => {
    const fetchPrograms = async () => {
      try {
        console.log("🚀 [useDistinctStrataPrograms] Fetching Programs . . . 🪝");
        ...
        console.error(
          "❌ [useDistinctStrataPrograms] Failed to fetch Programs:",
          err
        );
      }
    };
    ...
    fetchPrograms();
  }, [parentIdentifier, programSearch, page, perPage, sortColumn, sortDirection]);
