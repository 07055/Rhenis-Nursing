...
export const useDistinctStrataLessons = ({
  ...
  useEffect(() => {
    const fetchLessons = async () => {
      try {
        console.log("🚀 [useDistinctStrataLessons] Fetching Lessons . . . 🪝");
        ...
        console.error(
          "❌ [useDistinctStrataLessons] Failed to fetch Lessons:",
          err
        );
      }
    };
    ...
    fetchLessons();
  }, [parentIdentifier, lessonSearch, page, perPage, sortColumn, sortDirection]);
