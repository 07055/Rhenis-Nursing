...
export const useAbsoluteStrataDepartments = ({
  page = 1,
  perPage = 20,
  sortColumn = null,
  sortDirection = "asc",
  ...
  useEffect(() => {
    const fetchDepartments = async () => {
      try {
        console.log("🚀 [useAbsoluteStrataDepartments] Fetching Departments ... 🪝");
        ...
        console.error(
          "❌ [useAbsoluteStrataDepartments] Failed to fetch Departments:",
          err
        );
      }
    };
    ...
    fetchDepartments();
  }, [departmentSearch, page, perPage, sortColumn, sortDirection]);
