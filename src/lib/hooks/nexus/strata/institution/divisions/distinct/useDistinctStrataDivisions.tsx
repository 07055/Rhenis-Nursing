...
export const useDistinctStrataDivisions = ({
  ...
  useEffect(() => {
    const fetchDivisions = async () => {
      try {
        console.log("🚀 [useDistinctStrataDivisions] Fetching Divisions . . . 🪝");
        ...
        console.error(
          "❌ [useDistinctStrataDivisions] Failed to fetch Divisions:",
          err
        );
      }
    };
    ...
    fetchDivisions();
  }, [parentIdentifier, divisionSearch, page, perPage, sortColumn, sortDirection]);
