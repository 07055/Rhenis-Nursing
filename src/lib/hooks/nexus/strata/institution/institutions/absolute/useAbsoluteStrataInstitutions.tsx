...
export const useAbsoluteStrataInstitutions = ({
  page = 1,
  perPage = 20,
  sortColumn = null,
  sortDirection = "asc",
  ...
  useEffect(() => {
    const fetchInstitutions = async () => {
      try {
        console.log("🚀 [useAbsoluteStrataInstitutions] Fetching Institutions ... 🪝");
        ...
        console.error(
          "❌ [useAbsoluteStrataInstitutions] Failed to fetch Institutions:",
          err
        );
      }
    };
    ...
    fetchInstitutions();
  }, [institutionSearch, page, perPage, sortColumn, sortDirection]);
