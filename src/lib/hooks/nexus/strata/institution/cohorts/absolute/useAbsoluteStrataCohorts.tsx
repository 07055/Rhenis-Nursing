...
export const useAbsoluteStrataCohorts = ({
  page = 1,
  perPage = 20,
  sortColumn = null,
  sortDirection = "asc",
  ...
  useEffect(() => {
    const fetchCohorts = async () => {
      try {
        console.log("🚀 [useAbsoluteStrataCohorts] Fetching Cohorts ... 🪝");
        ...
        console.error(
          "❌ [useAbsoluteStrataCohorts] Failed to fetch Cohorts:",
          err
        );
      }
    };
    ...
    fetchCohorts();
  }, [cohortSearch, page, perPage, sortColumn, sortDirection]);
