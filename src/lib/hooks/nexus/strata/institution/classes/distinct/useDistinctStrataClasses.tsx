...
export const useDistinctStrataClasses = ({
  ...
  useEffect(() => {
    const fetchClasses = async () => {
      try {
        console.log("🚀 [useDistinctStrataClasses] Fetching Classes . . . 🪝");
        ...
        console.error(
          "❌ [useDistinctStrataClasses] Failed to fetch Classes:",
          err
        );
      }
    };
    ...
    fetchClasses();
  }, [parentIdentifier, classeSearch, page, perPage, sortColumn, sortDirection]);

  // Pass Classes when search changes [ Frontend is just to display !]
  useEffect(() => {
