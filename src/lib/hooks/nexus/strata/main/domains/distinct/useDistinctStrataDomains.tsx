...
export const useDistinctStrataDomains = ({
  ...
  useEffect(() => {
    const fetchDomains = async () => {
      try {
        console.log("🚀 [useDistinctStrataDomains] Fetching domains...");
        ...
        console.error(
          "❌ [useDistinctStrataDomains] Failed to fetch domains:",
          err
        );
      }
    };
    ...
    fetchDomains();
  }, [parentIdentifier, domainSearch, page, perPage, sortColumn, sortDirection]);
