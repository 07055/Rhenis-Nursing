...
export const useDistinctStrataSubCategories = ({
  ...
  useEffect(() => {
    const fetchSubCategories = async () => {
      try {
        console.log("🚀 [useDistinctStrataSubCategories] Fetching subcategories...");
        ...
        console.error(
          "❌ [useDistinctStrataSubCategories] Failed to fetch subcategories:",
          err
        );
      }
    };
    ...
    fetchSubCategories();
  }, [parentIdentifier, subcategorySearch, page, perPage, sortColumn, sortDirection]);
