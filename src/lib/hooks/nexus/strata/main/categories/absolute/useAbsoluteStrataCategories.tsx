...
export const useAbsoluteStrataCategories = ({
  page = 1,
  perPage = 20,
  sortColumn = null,
  sortDirection = "asc",
  ...
  useEffect(() => {
    const fetchCategories = async () => {
      try {
        console.log("🚀 [useAbsoluteStrataCategories] Fetching categories...");
        ...
        console.error(
          "❌ [useAbsoluteStrataCategories] Failed to fetch categories:",
          err
        );
      }
    };
    ...
    fetchCategories();
  }, [categorySearch, page, perPage, sortColumn, sortDirection]);

  // Pass categories when search changes [ Frontend is just to display !]
  useEffect(() => {
