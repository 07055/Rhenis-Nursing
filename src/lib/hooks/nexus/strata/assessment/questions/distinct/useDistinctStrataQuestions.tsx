...
export const useDistinctStrataQuestions = ({
  ...
  useEffect(() => {
    const fetchQuestions = async () => {
      try {
        console.log("🚀 [useDistinctStrataQuestions] Fetching Questions . . . 🪝");
        ...
        console.error(
          "❌ [useDistinctStrataQuestions] Failed to fetch Questions:",
          err
        );
      }
    };
    ...
    fetchQuestions();
  }, [parentIdentifier, questionSearch, page, perPage, sortColumn, sortDirection]);
