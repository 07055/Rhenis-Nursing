...
export const useAbsoluteStrataSections = ({
  page = 1,
  perPage = 20,
  sortColumn = null,
  sortDirection = "asc",
  ...
  useEffect(() => {
    const fetchSections = async () => {
      try {
        console.log("🚀 [useAbsoluteStrataSections] Fetching Sections ... 🪝");
        ...
        console.error(
          "❌ [useAbsoluteStrataSections] Failed to fetch Sections:",
          err
        );
      }
    };
    ...
    fetchSections();
  }, [sectionSearch, page, perPage, sortColumn, sortDirection]);
